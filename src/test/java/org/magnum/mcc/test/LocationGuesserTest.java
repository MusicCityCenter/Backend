...
public class LocationGuesserTest {
	...
	public void setUp(){
		...
		when(floorplan_.typeByName(roomType.getName())).thenReturn(roomType);
		when(floorplan_.typeByName(bathroomType.getName())).thenReturn(bathroomType);
		when(floorplan_.typeByName(bedroomType.getName())).thenReturn(bedroomType);
		when(floorplan_.typeByName(hallwayType.getName())).thenReturn(hallwayType);
		when(floorplan_.typeByName(kitchenType.getName())).thenReturn(kitchenType);
	}
