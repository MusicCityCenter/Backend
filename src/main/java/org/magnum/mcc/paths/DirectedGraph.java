...
public class DirectedGraph<T> implements Iterable<T> {
     ...
     * start node to the destination of the length and a corresponding edge
     * from the destination node to the start node with the same length.  
     * If an arc already existed, the length is updated to the specified value.  If either
